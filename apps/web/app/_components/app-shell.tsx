...
function NavIcon({ name }: { name: NavItem["icon"] }) {
  ...
  switch (name) {
    ...
    case "customers":
      return (
        <svg viewBox="0 0 24 24">
          ...
          <path {...common} d="M3 19c0-3 2.5-5 6-5s6 2 6 5" />
          <circle {...common} cx="18" cy="9" r="2" />
          <path {...common} d="M15.5 18c.5-1.6 1.9-2.9 3.8-3.3" />
        </svg>
      );
    case "billing":
      return (
        <svg viewBox="0 0 24 24">
          <path {...common} d="M7 3h10v18l-3-2-2 2-2-2-3 2z" />
    ...
    case "approvals":
      return (
        <svg viewBox="0 0 24 24">
          <path {...common} d="M20 7L10 17l-6-6" />
        </svg>
      );
    case "print":
      return (
        <svg viewBox="0 0 24 24">
          ...
          <rect {...common} x="4" y="8" width="16" height="8" rx="2" />
    ...
    case "review_qr":
      return (
        <svg viewBox="0 0 24 24">
          <path {...common} d="M4 4h5v5H4z" />
          <path {...common} d="M15 4h5v5h-5z" />
          <path {...common} d="M4 15h5v5H4z" />
          <path {...common} d="M15 15h2m-2 3h5m-2-3v5" />
        </svg>
      );
    case "reports":
      return (
        <svg viewBox="0 0 24 24">
          ...
          <path {...common} d="M17 16v-7" />
        </svg>
      );
    case "loss":
      return (
        <svg viewBox="0 0 24 24">
          <path {...common} d="M4 6l6 6 4-4 6 6" />
          <path {...common} d="M20 14v5h-5" />
        </svg>
      );
    case "settings":
      return (
        <svg viewBox="0 0 24 24">
          ...
          <path
            {...common}
            d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1 1 0 0 0-1.1-.2 1 1 0 0 0-.6.9V20a2 2 0 1 1-4 0v-.1a1 1 0 0 0-.6-.9 1 1 0 0 0-1.1.2l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.9-.6H4a2 2 0 1 1 0-4h.1a1 1 0 0 0 .9-.6 1 1 0 0 0-.2-1.1l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1 1 0 0 0 1.1.2h.1a1 1 0 0 0 .5-.9V4a2 2 0 1 1 4 0v.1a1 1 0 0 0 .6.9 1 1 0 0 0 1.1-.2l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1 1 0 0 0-.2 1.1v.1a1 1 0 0 0 .9.5H20a2 2 0 1 1 0 4h-.1a1 1 0 0 0-.9.6z"
          />
        </svg>
      );
    case "logout":
...
export function AppShell({ title, subtitle, children, navItems, appName, activeHref }: AppShellProps) {
