    ...
    <AppShell title="Monitors" subtitle="Monitor-linked customers" navItems={managerNavItems}>
      ...
      <div className="card">
        ...
        <p className="muted" style={{ marginTop: 0, fontSize: "0.85rem" }}>
          ...
          read meaningfully more on the monitor than their linked pricing accounts for — their fixed price may
          no longer match real usage.
        </p>
        {!kwhPriceAvailable && (
          <p className="muted" style={{ marginTop: 0, fontSize: "0.85rem" }}>
            No kWh price is set for {monthKey} yet (Settings → Pricing) — fixed-monthly customers&apos; linked
            kWh will show as <strong>—</strong> until it is.
          </p>
        )}
        <table>
          <thead>
